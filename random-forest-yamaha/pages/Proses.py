...
with st.expander(
    ...
    for jenis in urutan_jenis:
        ...
        tabel = tabel.rename(columns={
            ...
            "Indikasi Dominan": "Indikasi Dominan",
            "Rata-rata KM": "Rata-rata Kilometer",
            "Rata-rata Usia": "Rata-rata Usia (Tahun)",
    ...
    st.info(
        """
Karakteristik di atas merupakan hasil pengelompokan berdasarkan prediksi Random Forest.
Setiap jenis motor menampilkan karakteristik layanan yang paling dominan beserta
indikasi, rata-rata kilometer, rata-rata usia motor, dan jumlah data.
        """
    )
